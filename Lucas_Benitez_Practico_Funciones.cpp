...
void calculo(int& m, int& a, int& n) {
    int d = 1;
    n = (m <= 2 ?
    ...
    n = n % 7, n = (m <= 2) ? n : (n != 0 ? n - 1 : 6); //si no es enero o febrero, a n le resto 1 o si es n == 0 lo paso a n = 6, porque (0 -1) = -1 
}
int impresion(int& m, int& a, int& n) {
    int d = 1;
